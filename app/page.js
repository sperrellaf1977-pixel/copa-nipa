...
const allSponsors = [
  ...
  { logo: "/logo-five-stars.png", name: "LRA", url: "https://www.lraincorporadora.com.br", tier: "time" },
        ...
        <div className="mx-auto max-w-7xl px-6 py-4">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-4">
              <img src="/logo-copa-nipa.png" alt="Nova Ipanema" className="h-16 w-16 object-contain rounded-full" />
              <div>
      ...
      <main className="mx-auto max-w-7xl px-6 py-12 lg:px-10">
        ...
        <footer className="mt-20 flex flex-wrap items-center justify-between gap-4 border-t border-white/[0.06] pt-10">
          <div className="flex items-center gap-3">
            <img src="/logo-copa-nipa.png" alt="Nova Ipanema" className="h-14 w-14 object-contain rounded-full" />
            <div>
